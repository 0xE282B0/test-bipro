...
import net.bipro.namespace.datentypen.STSanierungsart;
...
/**
 * Klasse zur genauen Ermittlung der Sanierungskriterien, sowie Kernsanierungen.
 * 
 * <p>Java class for CT_Sanierung complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="CT_Sanierung"&gt;
 *   &lt;complexContent&gt;
 *     &lt;extension base="{http://www.bipro.net/namespace/basis}CT_Objekt"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="ArtID" type="{http://www.bipro.net/namespace/datentypen}ST_Sanierungsart"/&gt;
 *         &lt;element name="Anteil" type="{http://www.bipro.net/namespace/datentypen}ST_Prozent" minOccurs="0"/&gt;
 *         &lt;element name="Jahr" type="{http://www.bipro.net/namespace/datentypen}ST_Jahr" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "CT_Sanierung", propOrder = {
    "artID",
    "anteil",
    "jahr"
})
@Generated(value = "com.sun.tools.xjc.Driver", date = "2021-04-19T05:38:04+02:00", comments = "JAXB RI v2.3.2")
public class CTSanierung
    extends CTObjekt
    implements Cloneable, CopyTo2, Equals2, HashCode2
{
    ...
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2021-04-19T05:38:04+02:00", comments = "JAXB RI v2.3.2")
    protected STSanierungsart artID;
     ...
     * @return
     *     possible object is
     *     {@link STSanierungsart }
     *     
     */
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2021-04-19T05:38:04+02:00", comments = "JAXB RI v2.3.2")
    public STSanierungsart getArtID() {
        return artID;
    }
     ...
     */
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2021-04-19T05:38:04+02:00", comments = "JAXB RI v2.3.2")
    public void setArtID(STSanierungsart value) {
        this.artID = value;
    }
     ...
     */
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2021-04-19T05:38:04+02:00", comments = "JAXB RI v2.3.2")
    public void setJahr(Integer value) {
        this.jahr = value;
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final CTSanierung that = ((CTSanierung) object);
        {
            STSanierungsart lhsArtID;
            lhsArtID = this.getArtID();
            STSanierungsart rhsArtID;
        ...
        {
            Integer lhsJahr;
            lhsJahr = this.getJahr();
            Integer rhsJahr;
            rhsJahr = that.getJahr();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "jahr", lhsJahr), LocatorUtils.property(thatLocator, "jahr", rhsJahr), lhsJahr, rhsJahr, (this.jahr!= null), (that.jahr!= null))) {
                return false;
            }
        }
        return true;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            Integer theJahr;
            theJahr = this.getJahr();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "jahr", theJahr), currentHashCode, theJahr, (this.jahr!= null));
        }
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof CTSanierung) {
            final CTSanierung copy = ((CTSanierung) draftCopy);
            {
                ...
                if (artIDShouldBeCopiedAndSet == Boolean.TRUE) {
                    STSanierungsart sourceArtID;
                    sourceArtID = this.getArtID();
                    STSanierungsart copyArtID = ((STSanierungsart) strategy.copy(LocatorUtils.property(locator, "artID", sourceArtID), sourceArtID, (this.artID!= null)));
            ...
            {
                Boolean jahrShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, (this.jahr!= null));
                if (jahrShouldBeCopiedAndSet == Boolean.TRUE) {
                    Integer sourceJahr;
                    sourceJahr = this.getJahr();
                    Integer copyJahr = ((Integer) strategy.copy(LocatorUtils.property(locator, "jahr", sourceJahr), sourceJahr, (this.jahr!= null)));
                    copy.setJahr(copyJahr);
                } else {
                    if (jahrShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.jahr = null;
                    }
                }
            }
    ...
    public Object createNewInstance() {
        return new CTSanierung();
    }

    @Generated(value = "com.sun.tools.xjc.Driver", date = "2021-04-19T05:38:04+02:00", comments = "JAXB RI v2.3.2")
    public CTSanierung withArtID(STSanierungsart value) {
        setArtID(value);
        return this;
    }

    @Generated(value = "com.sun.tools.xjc.Driver", date = "2021-04-19T05:38:04+02:00", comments = "JAXB RI v2.3.2")
    public CTSanierung withAnteil(BigDecimal value) {
        setAnteil(value);
        return this;
    }

    @Generated(value = "com.sun.tools.xjc.Driver", date = "2021-04-19T05:38:04+02:00", comments = "JAXB RI v2.3.2")
    public CTSanierung withJahr(Integer value) {
        setJahr(value);
        return this;
    }
    ...
    @Override
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2021-04-19T05:38:04+02:00", comments = "JAXB RI v2.3.2")
    public CTSanierung withErweiterung(CTErweiterung... values) {
        if (values!= null) {
    ...
    @Override
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2021-04-19T05:38:04+02:00", comments = "JAXB RI v2.3.2")
    public CTSanierung withErweiterung(Collection<CTErweiterung> values) {
        if (values!= null) {
