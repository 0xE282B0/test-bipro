...
/**
 * Klasse zur Abbildung eines Betriebshaftpflichtwagnisses.
 * 
 * <p>Java class for CT_Betriebshaftpflicht complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="CT_Betriebshaftpflicht"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "CT_Betriebshaftpflicht", propOrder = {
    "wagnisanschrift"
})
@Generated(value = "com.sun.tools.xjc.Driver", date = "2021-03-19T04:27:26+01:00", comments = "JAXB RI v2.3.2")
public class CTBetriebshaftpflicht
    extends CTObjekt
    implements Cloneable, CopyTo2, Equals2, HashCode2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final CTBetriebshaftpflicht that = ((CTBetriebshaftpflicht) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof CTBetriebshaftpflicht) {
            final CTBetriebshaftpflicht copy = ((CTBetriebshaftpflicht) draftCopy);
            {
    ...
    public Object createNewInstance() {
        return new CTBetriebshaftpflicht();
    }

    @Generated(value = "com.sun.tools.xjc.Driver", date = "2021-03-19T04:27:26+01:00", comments = "JAXB RI v2.3.2")
    public CTBetriebshaftpflicht withWagnisanschrift(CTWagnisanschrift value) {
    ...
    @Override
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2021-03-19T04:27:26+01:00", comments = "JAXB RI v2.3.2")
    public CTBetriebshaftpflicht withErweiterung(CTErweiterung... values) {
        if (values!= null) {
    ...
    @Override
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2021-03-19T04:27:26+01:00", comments = "JAXB RI v2.3.2")
    public CTBetriebshaftpflicht withErweiterung(Collection<CTErweiterung> values) {
        if (values!= null) {
