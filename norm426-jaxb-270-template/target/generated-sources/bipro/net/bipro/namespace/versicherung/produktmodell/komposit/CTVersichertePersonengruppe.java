...
/**
 * Die Klasse VersichertePersonengruppe identifiziert die Personengruppe, die durch die Deckung versichert ist.
 * 
 * <p>Java class for CT_VersichertePersonengruppe complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="CT_VersichertePersonengruppe"&gt;
 *   &lt;complexContent&gt;
 *     &lt;extension base="{http://www.bipro.net/namespace/partner}CT_Personengruppenrolle"&gt;
 *       &lt;sequence&gt;
...
@XmlType(name = "CT_VersichertePersonengruppe", propOrder = {
    "gefahrengruppe"
})
@Generated(value = "com.sun.tools.xjc.Driver", date = "2021-04-19T05:38:04+02:00", comments = "JAXB RI v2.3.2")
public class CTVersichertePersonengruppe
    extends CTPersonengruppenrolle
    implements Cloneable, CopyTo2, Equals2, HashCode2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final CTVersichertePersonengruppe that = ((CTVersichertePersonengruppe) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof CTVersichertePersonengruppe) {
            final CTVersichertePersonengruppe copy = ((CTVersichertePersonengruppe) draftCopy);
            {
    ...
    public Object createNewInstance() {
        return new CTVersichertePersonengruppe();
    }

    @Generated(value = "com.sun.tools.xjc.Driver", date = "2021-04-19T05:38:04+02:00", comments = "JAXB RI v2.3.2")
    public CTVersichertePersonengruppe withGefahrengruppe(STGefahrengruppe value) {
    ...
    @Override
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2021-04-19T05:38:04+02:00", comments = "JAXB RI v2.3.2")
    public CTVersichertePersonengruppe withPersonengruppenID(String value) {
    ...
    @Override
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2021-04-19T05:38:04+02:00", comments = "JAXB RI v2.3.2")
    public CTVersichertePersonengruppe withErweiterung(CTErweiterung... values) {
        if (values!= null) {
    ...
    @Override
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2021-04-19T05:38:04+02:00", comments = "JAXB RI v2.3.2")
    public CTVersichertePersonengruppe withErweiterung(Collection<CTErweiterung> values) {
        if (values!= null) {
