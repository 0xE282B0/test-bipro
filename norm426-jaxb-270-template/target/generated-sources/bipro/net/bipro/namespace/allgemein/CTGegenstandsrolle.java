...
import net.bipro.namespace.sachen.CTEntfernungZu;
import net.bipro.namespace.versicherung.haftpflicht.CTVersichertesSportboot;
import net.bipro.namespace.versicherung.haftpflicht.CTVersichertesTier;
import net.bipro.namespace.versicherung.produktmodell.komposit.CTVersichertesObjekt;
...
/**
 * <p>Java class for CT_Gegenstandsrolle complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="CT_Gegenstandsrolle"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "CT_Gegenstandsrolle", propOrder = {
    "gegenstandID"
})
@XmlSeeAlso({
    CTVersichertesSportboot.class,
    CTVersichertesTier.class,
    CTBeinhaltet.class,
    CTVersichertesObjekt.class,
    CTEntfernungZu.class
})
@Generated(value = "com.sun.tools.xjc.Driver", date = "2021-04-19T05:38:04+02:00", comments = "JAXB RI v2.3.2")
public abstract class CTGegenstandsrolle
    extends CTObjekt
    implements Cloneable, CopyTo2, Equals2, HashCode2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final CTGegenstandsrolle that = ((CTGegenstandsrolle) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (target instanceof CTGegenstandsrolle) {
            final CTGegenstandsrolle copy = ((CTGegenstandsrolle) target);
            {
    ...
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2021-04-19T05:38:04+02:00", comments = "JAXB RI v2.3.2")
    public CTGegenstandsrolle withGegenstandID(String value) {
    ...
    @Override
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2021-04-19T05:38:04+02:00", comments = "JAXB RI v2.3.2")
    public CTGegenstandsrolle withErweiterung(CTErweiterung... values) {
        if (values!= null) {
    ...
    @Override
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2021-04-19T05:38:04+02:00", comments = "JAXB RI v2.3.2")
    public CTGegenstandsrolle withErweiterung(Collection<CTErweiterung> values) {
        if (values!= null) {
