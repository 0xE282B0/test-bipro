 ...
 * 
 * <p>Java class for CT_Zeitraum complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="CT_Zeitraum"&gt;
 *   &lt;complexContent&gt;
 *     &lt;extension base="{http://www.bipro.net/namespace/basis}CT_Objekt"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="Beginn" type="{http://www.bipro.net/namespace/datentypen}ST_DatumZeit" minOccurs="0"/&gt;
 *         &lt;element name="Ende" type="{http://www.bipro.net/namespace/datentypen}ST_DatumZeit" minOccurs="0"/&gt;
 *         &lt;element name="AnzahlJahre" type="{http://www.bipro.net/namespace/datentypen}ST_Ganzzahl" minOccurs="0"/&gt;
 *         &lt;element name="AnzahlMonate" type="{http://www.bipro.net/namespace/datentypen}ST_Monate" minOccurs="0"/&gt;
...
@XmlType(name = "CT_Zeitraum", propOrder = {
    "beginn",
    "ende",
    "anzahlJahre",
    "anzahlMonate",
    ...
    implements Cloneable, CopyTo2, Equals2, HashCode2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final CTZeitraum that = ((CTZeitraum) object);
        {
            String lhsBeginn;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof CTZeitraum) {
            final CTZeitraum copy = ((CTZeitraum) draftCopy);
            {
    ...
    public Object createNewInstance() {
        return new CTZeitraum();
    }

    @Generated(value = "com.sun.tools.xjc.Driver", date = "2021-03-19T04:27:26+01:00", comments = "JAXB RI v2.3.2")
    public CTZeitraum withBeginn(String value) {
        setBeginn(value);
        return this;
    }

    @Generated(value = "com.sun.tools.xjc.Driver", date = "2021-03-19T04:27:26+01:00", comments = "JAXB RI v2.3.2")
    public CTZeitraum withEnde(String value) {
        setEnde(value);
        return this;
    }

    @Generated(value = "com.sun.tools.xjc.Driver", date = "2021-03-19T04:27:26+01:00", comments = "JAXB RI v2.3.2")
    public CTZeitraum withAnzahlJahre(Integer value) {
        setAnzahlJahre(value);
        return this;
    }

    @Generated(value = "com.sun.tools.xjc.Driver", date = "2021-03-19T04:27:26+01:00", comments = "JAXB RI v2.3.2")
    public CTZeitraum withAnzahlMonate(Integer value) {
        setAnzahlMonate(value);
        return this;
    }

    @Generated(value = "com.sun.tools.xjc.Driver", date = "2021-03-19T04:27:26+01:00", comments = "JAXB RI v2.3.2")
    public CTZeitraum withAnzahlTage(Integer value) {
        setAnzahlTage(value);
        return this;
    }
    ...
    @Override
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2021-03-19T04:27:26+01:00", comments = "JAXB RI v2.3.2")
    public CTZeitraum withErweiterung(CTErweiterung... values) {
        if (values!= null) {
    ...
    @Override
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2021-03-19T04:27:26+01:00", comments = "JAXB RI v2.3.2")
    public CTZeitraum withErweiterung(Collection<CTErweiterung> values) {
        if (values!= null) {
