...
import net.bipro.namespace.versicherung.haftpflicht.CTHauptwagnis;
import net.bipro.namespace.versicherung.produktmodell.komposit.CTVersichertesWagnis;
...
/**
 * <p>Java class for CT_Aktivitaetsrolle complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="CT_Aktivitaetsrolle"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "CT_Aktivitaetsrolle", propOrder = {
    "aktivitaetID"
})
@XmlSeeAlso({
    CTHauptwagnis.class,
    CTVersichertesWagnis.class
})
@Generated(value = "com.sun.tools.xjc.Driver", date = "2021-04-19T05:38:04+02:00", comments = "JAXB RI v2.3.2")
public abstract class CTAktivitaetsrolle
    extends CTObjekt
    implements Cloneable, CopyTo2, Equals2, HashCode2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final CTAktivitaetsrolle that = ((CTAktivitaetsrolle) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (target instanceof CTAktivitaetsrolle) {
            final CTAktivitaetsrolle copy = ((CTAktivitaetsrolle) target);
            {
    ...
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2021-04-19T05:38:04+02:00", comments = "JAXB RI v2.3.2")
    public CTAktivitaetsrolle withAktivitaetID(String value) {
    ...
    @Override
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2021-04-19T05:38:04+02:00", comments = "JAXB RI v2.3.2")
    public CTAktivitaetsrolle withErweiterung(CTErweiterung... values) {
        if (values!= null) {
    ...
    @Override
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2021-04-19T05:38:04+02:00", comments = "JAXB RI v2.3.2")
    public CTAktivitaetsrolle withErweiterung(Collection<CTErweiterung> values) {
        if (values!= null) {
