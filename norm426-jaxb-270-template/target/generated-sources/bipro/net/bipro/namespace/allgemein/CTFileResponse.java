...
/**
 * Nachrichten-Objekt zur Übertragung von Dateien
 * 
 * <p>Java class for CT_FileResponse complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="CT_FileResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "CT_FileResponse", propOrder = {
    "datei"
})
@Generated(value = "com.sun.tools.xjc.Driver", date = "2021-03-19T04:27:26+01:00", comments = "JAXB RI v2.3.2")
public class CTFileResponse
    ...
    implements Cloneable, CopyTo2, Equals2, HashCode2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final CTFileResponse that = ((CTFileResponse) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof CTFileResponse) {
            final CTFileResponse copy = ((CTFileResponse) draftCopy);
            {
    ...
    public Object createNewInstance() {
        return new CTFileResponse();
    }

    @Generated(value = "com.sun.tools.xjc.Driver", date = "2021-03-19T04:27:26+01:00", comments = "JAXB RI v2.3.2")
    public CTFileResponse withDatei(CTDatei... values) {
        if (values!= null) {
    ...
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2021-03-19T04:27:26+01:00", comments = "JAXB RI v2.3.2")
    public CTFileResponse withDatei(Collection<CTDatei> values) {
        if (values!= null) {
    ...
    @Override
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2021-03-19T04:27:26+01:00", comments = "JAXB RI v2.3.2")
    public CTFileResponse withBiPROVersion(String value) {
    ...
    @Override
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2021-03-19T04:27:26+01:00", comments = "JAXB RI v2.3.2")
    public CTFileResponse withConsumerID(String value) {
        setConsumerID(value);
        return this;
    }
    ...
    @Override
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2021-03-19T04:27:26+01:00", comments = "JAXB RI v2.3.2")
    public CTFileResponse withStatus(CTStatus value) {
        setStatus(value);
        return this;
    }
    ...
    @Override
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2021-03-19T04:27:26+01:00", comments = "JAXB RI v2.3.2")
    public CTFileResponse withErweiterung(CTErweiterung... values) {
        if (values!= null) {
    ...
    @Override
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2021-03-19T04:27:26+01:00", comments = "JAXB RI v2.3.2")
    public CTFileResponse withErweiterung(Collection<CTErweiterung> values) {
        if (values!= null) {
