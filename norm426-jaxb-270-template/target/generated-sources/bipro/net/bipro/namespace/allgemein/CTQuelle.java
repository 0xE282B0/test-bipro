...
/**
 * Partner, der der Ursprung einer Information ist.
 * 
 * <p>Java class for CT_Quelle complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="CT_Quelle"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "CT_Quelle", propOrder = {
    "partnerID"
})
@Generated(value = "com.sun.tools.xjc.Driver", date = "2021-03-19T04:27:26+01:00", comments = "JAXB RI v2.3.2")
public class CTQuelle
    extends CTObjekt
    implements Cloneable, CopyTo2, Equals2, HashCode2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final CTQuelle that = ((CTQuelle) object);
        {
            String lhsPartnerID;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof CTQuelle) {
            final CTQuelle copy = ((CTQuelle) draftCopy);
            {
    ...
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2021-03-19T04:27:26+01:00", comments = "JAXB RI v2.3.2")
    public CTQuelle withPartnerID(String value) {
        setPartnerID(value);
        return this;
    }
    ...
    @Override
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2021-03-19T04:27:26+01:00", comments = "JAXB RI v2.3.2")
    public CTQuelle withErweiterung(CTErweiterung... values) {
        if (values!= null) {
    ...
    @Override
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2021-03-19T04:27:26+01:00", comments = "JAXB RI v2.3.2")
    public CTQuelle withErweiterung(Collection<CTErweiterung> values) {
        if (values!= null) {
