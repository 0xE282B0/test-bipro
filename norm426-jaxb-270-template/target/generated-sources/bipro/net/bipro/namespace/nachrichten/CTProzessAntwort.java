...
/**
 * Prozess-Objekt. Alle Antwort-Nachrichten innerhalb der von der BiPRO definierten Prozesse werden von diesem Datentypen abgeleitet.
 * 
 * <p>Java class for CT_ProzessAntwort complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="CT_ProzessAntwort"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "CT_ProzessAntwort", propOrder = {
    "biPROVersion",
    "consumerID",
    "status"
})
@XmlSeeAlso({
    CTFileResponse.class,
    CTOfferResponse.class,
    CTOrderResponse.class,
    CTQuoteResponse.class
})
@Generated(value = "com.sun.tools.xjc.Driver", date = "2021-03-19T04:27:26+01:00", comments = "JAXB RI v2.3.2")
public abstract class CTProzessAntwort
    extends CTObjekt
    implements Cloneable, CopyTo2, Equals2, HashCode2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final CTProzessAntwort that = ((CTProzessAntwort) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (target instanceof CTProzessAntwort) {
            final CTProzessAntwort copy = ((CTProzessAntwort) target);
            {
    ...
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2021-03-19T04:27:26+01:00", comments = "JAXB RI v2.3.2")
    public CTProzessAntwort withBiPROVersion(String value) {
        setBiPROVersion(value);
        return this;
    }

    @Generated(value = "com.sun.tools.xjc.Driver", date = "2021-03-19T04:27:26+01:00", comments = "JAXB RI v2.3.2")
    public CTProzessAntwort withConsumerID(String value) {
        setConsumerID(value);
        return this;
    }

    @Generated(value = "com.sun.tools.xjc.Driver", date = "2021-03-19T04:27:26+01:00", comments = "JAXB RI v2.3.2")
    public CTProzessAntwort withStatus(CTStatus value) {
        setStatus(value);
        return this;
    }
    ...
    @Override
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2021-03-19T04:27:26+01:00", comments = "JAXB RI v2.3.2")
    public CTProzessAntwort withErweiterung(CTErweiterung... values) {
        if (values!= null) {
    ...
    @Override
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2021-03-19T04:27:26+01:00", comments = "JAXB RI v2.3.2")
    public CTProzessAntwort withErweiterung(Collection<CTErweiterung> values) {
        if (values!= null) {
