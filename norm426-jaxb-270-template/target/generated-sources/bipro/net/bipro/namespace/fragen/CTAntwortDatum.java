...
/**
 * Ableitung der Klasse Antwort zur typisierten Übertragung eines Datums als Antwort.
 * 
 * <p>Java class for CT_AntwortDatum complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="CT_AntwortDatum"&gt;
 *   &lt;complexContent&gt;
 *     &lt;extension base="{http://www.bipro.net/namespace/fragen}CT_Antwort"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="Datum" type="{http://www.bipro.net/namespace/datentypen}ST_Datum"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "CT_AntwortDatum", propOrder = {
    "datum"
})
@Generated(value = "com.sun.tools.xjc.Driver", date = "2021-03-19T04:27:26+01:00", comments = "JAXB RI v2.3.2")
public class CTAntwortDatum
    extends CTAntwort
    implements Cloneable, CopyTo2, Equals2, HashCode2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final CTAntwortDatum that = ((CTAntwortDatum) object);
        {
            String lhsDatum;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof CTAntwortDatum) {
            final CTAntwortDatum copy = ((CTAntwortDatum) draftCopy);
            {
    ...
    public Object createNewInstance() {
        return new CTAntwortDatum();
    }

    @Generated(value = "com.sun.tools.xjc.Driver", date = "2021-03-19T04:27:26+01:00", comments = "JAXB RI v2.3.2")
    public CTAntwortDatum withDatum(String value) {
        setDatum(value);
        return this;
    }
    ...
    @Override
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2021-03-19T04:27:26+01:00", comments = "JAXB RI v2.3.2")
    public CTAntwortDatum withFreitext(String value) {
        setFreitext(value);
        return this;
    }
    ...
    @Override
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2021-03-19T04:27:26+01:00", comments = "JAXB RI v2.3.2")
    public CTAntwortDatum withErweiterung(CTErweiterung... values) {
        if (values!= null) {
    ...
    @Override
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2021-03-19T04:27:26+01:00", comments = "JAXB RI v2.3.2")
    public CTAntwortDatum withErweiterung(Collection<CTErweiterung> values) {
        if (values!= null) {
