...
/**
 * Ableitung der Klasse Antwort zur typisierten Übertragung einer Partner Antwort.
 * Das mittels dem Attribut PartnerID referenzierte Partnerobjekt MUSS in der Partnerliste der Nachricht enthalten sein.
 * 
 * <p>Java class for CT_AntwortPartner complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="CT_AntwortPartner"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "CT_AntwortPartner", propOrder = {
    "partnerID"
})
@Generated(value = "com.sun.tools.xjc.Driver", date = "2021-04-19T05:38:04+02:00", comments = "JAXB RI v2.3.2")
public class CTAntwortPartner
    extends CTAntwort
    implements Cloneable, CopyTo2, Equals2, HashCode2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final CTAntwortPartner that = ((CTAntwortPartner) object);
        {
            String lhsPartnerID;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof CTAntwortPartner) {
            final CTAntwortPartner copy = ((CTAntwortPartner) draftCopy);
            {
    ...
    public Object createNewInstance() {
        return new CTAntwortPartner();
    }

    @Generated(value = "com.sun.tools.xjc.Driver", date = "2021-04-19T05:38:04+02:00", comments = "JAXB RI v2.3.2")
    public CTAntwortPartner withPartnerID(String value) {
        setPartnerID(value);
        return this;
    }
    ...
    @Override
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2021-04-19T05:38:04+02:00", comments = "JAXB RI v2.3.2")
    public CTAntwortPartner withFreitext(String value) {
        setFreitext(value);
        return this;
    }
    ...
    @Override
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2021-04-19T05:38:04+02:00", comments = "JAXB RI v2.3.2")
    public CTAntwortPartner withErweiterung(CTErweiterung... values) {
        if (values!= null) {
    ...
    @Override
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2021-04-19T05:38:04+02:00", comments = "JAXB RI v2.3.2")
    public CTAntwortPartner withErweiterung(Collection<CTErweiterung> values) {
        if (values!= null) {
