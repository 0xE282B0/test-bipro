...
public class HexBinary implements Cloneable, CopyTo2, Equals2, HashCode2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final HexBinary that = ((HexBinary) object);
        {
            byte[] lhsValue;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof HexBinary) {
            final HexBinary copy = ((HexBinary) draftCopy);
            {
                Boolean valueShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, (this.value!= null));
                if (valueShouldBeCopiedAndSet == Boolean.TRUE) {
                    byte[] sourceValue;
                    sourceValue = this.getValue();
                    byte[] copyValue = ((byte[]) strategy.copy(LocatorUtils.property(locator, "value", sourceValue), sourceValue, (this.value!= null)));
            ...
            {
                Boolean contentTypeShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, (this.contentType!= null));
                if (contentTypeShouldBeCopiedAndSet == Boolean.TRUE) {
                    String sourceContentType;
                    sourceContentType = this.getContentType();
                    String copyContentType = ((String) strategy.copy(LocatorUtils.property(locator, "contentType", sourceContentType), sourceContentType, (this.contentType!= null)));
    ...
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2021-03-19T04:27:26+01:00", comments = "JAXB RI v2.3.2")
    public HexBinary withValue(byte[] value) {
        setValue(value);
        return this;
    }

    @Generated(value = "com.sun.tools.xjc.Driver", date = "2021-03-19T04:27:26+01:00", comments = "JAXB RI v2.3.2")
    public HexBinary withContentType(String value) {
